...
# Baby Steps - Stripe Setup Script
...
echo "----------------------------------------"
echo ""
echo "You need to create 3 products with Payment Links:"
echo ""
echo "Product 1: Baby Steps - Launch Monthly"
echo "  - Name: Baby Steps Premium (Launch Price)"
echo "  - Price: £6.99/month"
echo "  - Trial period: 14 days"
echo "  - Description: Lock in launch pricing forever - Premium pregnancy planner"
echo ""
echo "Product 2: Baby Steps - Regular Monthly" 
echo "  - Name: Baby Steps Premium"
echo "  - Price: £7.99/month"
echo "  - Trial period: 14 days"
echo "  - Description: Complete pregnancy planning solution with unlimited features"
echo ""
echo "Product 3: Baby Steps - Annual"
echo "  - Name: Baby Steps Premium Annual"
echo "  - Price: £69.99/year"
echo "  - Trial period: 14 days"
echo "  - Description: Save £26 with annual billing - Best value!"
echo ""
read -p "Press Enter when you've created all 3 products..."
...
echo ""
read -p "Press Enter when you've created all payment links..."
...
echo ""
echo "REACT_APP_STRIPE_LAUNCH_MONTHLY_URL=[Your launch monthly payment link]"
echo "REACT_APP_STRIPE_REGULAR_MONTHLY_URL=[Your regular monthly payment link]"
echo "REACT_APP_STRIPE_ANNUAL_URL=[Your annual payment link]"
echo ""
echo "Example format:"
echo "REACT_APP_STRIPE_LAUNCH_MONTHLY_URL=https://buy.stripe.com/test_abc123xyz"
echo ""
