-- ============================================
-- FINAL IMPORT FUNCTION - With valid priority values
-- ============================================
...
BEGIN
    ...
    LOOP
        ...
        -- Handle null or invalid priority values
        v_priority := CASE 
        ...
        INSERT INTO baby_items (
            ...
            v_item.item_name,
            v_item.quantity,
            v_priority,  -- Using validated priority
...
FROM pg_constraint 
WHERE conrelid = 'baby_items'::regclass
AND conname LIKE '%priority%';

-- Success message
SELECT 'Function created with priority validation!' as status;
