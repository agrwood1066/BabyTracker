-- Update Stripe price IDs with actual values
-- Run this to update the webhook function with your real Stripe price IDs
...
BEGIN
    ...
    -- Map price ID to plan - UPDATED WITH YOUR ACTUAL PRICE IDs
    CASE p_price_id
