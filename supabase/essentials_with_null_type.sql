-- ============================================
-- ESSENTIALS IMPORT - NULL LIST_TYPE VERSION
-- Using NULL for list_type since it's nullable
-- ============================================

-- Step 1: Insert with NULL list_type (since the column allows NULL)
INSERT INTO preset_lists (
    name,
    description,
    slug,
    list_type,  -- We'll use NULL here
    item_count
) 
VALUES (
    ...
    'essentials',
    NULL,  -- Using NULL since list_type is nullable
    48
) 
