-- ============================================
-- ULTRA MINIMAL IMPORT FUNCTION - Basic fields only
-- ============================================
...
BEGIN
    ...
    -- Import the items - ONLY the most basic fields
    FOR v_item IN 
        SELECT 
            item_name,
    ...
    LOOP
        ...
        -- Insert the item with ONLY fields we know exist in baby_items
