-- ============================================
-- FINAL COMPLETE FIX - Including user_id column
-- ============================================
...
BEGIN
    ...
    -- Record the import - INCLUDING user_id
    ...
    IF v_existing_usage_id IS NOT NULL THEN
        ...
        SET 
            ...
            imported_at = NOW(),
            user_id = p_user_id  -- Update user_id in case it's different
...
SELECT 
    ...
    (SELECT COUNT(*) FROM preset_list_items WHERE preset_list_id = (SELECT id FROM preset_lists WHERE slug = 'essentials')) as items_count;

-- Show columns in preset_list_usage to confirm structure
SELECT 
    'preset_list_usage columns:' as table_info,
