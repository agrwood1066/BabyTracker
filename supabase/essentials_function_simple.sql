-- ============================================
-- SIMPLIFIED IMPORT FUNCTION - No price references
-- ============================================
...
BEGIN
    ...
    LOOP
        ...
        -- Insert the item (without price fields that don't exist)
...
-- Let's also check what columns actually exist in preset_list_items
